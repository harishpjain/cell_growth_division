...
# Error and log files
#SBATCH --error=/cluster/projects/nn8100k/harish_workspace/error_files/nemdemo52.err
#SBATCH --output=/cluster/projects/nn8100k/harish_workspace/log_files/nemdemo52.out
