...
namespace AMDiS
{
  ...
  */
    ...
    void sendVolume(std::vector<std::vector<float>> out_volume, int numRanks, int source){
    ...
    void recvVolume(std::vector<std::vector<float>>& in_volume, int numRanks, int target){
