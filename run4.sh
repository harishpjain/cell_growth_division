...
# Error and log files
#SBATCH --error=/cluster/projects/nn8100k/harish_workspace/error_files/nemdemo64.err
#SBATCH --output=/cluster/projects/nn8100k/harish_workspace/log_files/nemdemo64.out
...
srun ./build/divisionless_nem_neoint_model init/neoinit_nematic_5.2d